CXX := g++
CXXFLAGS := -std=c++17 -Wall -Wextra -Wpedantic -Wshadow -pedantic-errors
...
#
# OBJECTS will be our .o files correspondent with files in SOURCES (file.cpp -> file.o).
#
...
#
# Define a pattern rule that compiles every .o file with its correspondent .cpp file.
$(LIBDIR)/%.o: $(SRCDIR)/%.cpp
